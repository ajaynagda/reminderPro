...
/* harmony export (binding) */ __webpack_require__.d(exports, "__DO_NOT_USE__ActionTypes", function() { return ActionTypes; });
/* harmony export (binding) */ __webpack_require__.d(exports, "combineReducers", function() { return combineReducers; });
/* harmony export (binding) */ __webpack_require__.d(exports, "bindActionCreators", function() { return bindActionCreators; });
/* harmony export (binding) */ __webpack_require__.d(exports, "applyMiddleware", function() { return applyMiddleware; });
/* harmony export (binding) */ __webpack_require__.d(exports, "compose", function() { return compose; });
/* harmony export (binding) */ __webpack_require__.d(exports, "createStore", function() { return createStore; });
...
/* harmony reexport (binding) */ __webpack_require__.d(exports, "createProvider", function() { return __WEBPACK_IMPORTED_MODULE_0__components_Provider__["b"]; });
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(22);
...
var App = function (_Component) {
	...
	_createClass(App, [{
		...
		value: function addReminder() {
			this.props.addReminder((0, _reactDom.findDOMNode)(this.refs.txtReminder).value);
		}
	}, {
		key: 'deleteReminder1',
		value: function deleteReminder1(id) {
			console.log(id);
		...
		value: function renderReminders() {
			...
			return _react2.default.createElement(
				'ul',
				{ className: 'list-group col-sm-4 btt' },
						...
						_react2.default.createElement(
							'div',
							{
								...
								onClick: function onClick() {
									return _this2.deleteReminder1(reminder.id);
								}
							},
							'\u2715'
						)
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('input', { className: 'form-control', ref: 'txtReminder', placeholder: 'i want to do' }),
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-success', type: 'button', onClick: function onClick() {
								return _this3.addReminder();
							} },
						'Add to Reminder'
					),
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-danger delete-button', type: 'button', onClick: function onClick() {
								return _this3.props.clearReminder();
							} },
						'Clear Reminder'
					)
				),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { addReminder: _actions.addReminder, deleteReminder: _actions.deleteReminder, clearReminder: _actions.clearReminder })(App);
...
var _sfcookies = __webpack_require__(62);
...
var addReminder = exports.addReminder = function addReminder(text) {
      return {
            type: 'ADD_REMINDER', payload: text
      };
};

var deleteReminder = exports.deleteReminder = function deleteReminder(id) {
      return {
            type: 'DELETE_REMINDER', payload: id
      };
};

var clearReminder = exports.clearReminder = function clearReminder() {
      return {
            type: 'CLEAR_REMINDER'
      };
};
...
*/
var ba=__webpack_require__(2),ea=__webpack_require__(3),m=__webpack_require__(13),A=__webpack_require__(4),C=__webpack_require__(1),fa=__webpack_require__(15),ha=__webpack_require__(16),ja=__webpack_require__(14),ka=__webpack_require__(5);
...
/* harmony export (immutable) */ exports["b"] = createProvider;
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23), __webpack_require__(67)(module)))
